...
import at.bitfire.dav4android.OAuthAuthenticator;
...
public class HttpClient extends OkHttpClient {
    ...
    static {
        ...
        userAgent = "DAVdroid/"
                ...
                + " (" + date + "; dav4android) Android/"
                + Build.VERSION.RELEASE;
    }

    final Logger log;
    final Context context;
    protected String username, password, authToken;
    ...
    protected HttpClient(Logger log, Context context) {
        ...
        if (context != null) {
            ...
            setSslSocketFactory(new SSLSocketFactoryCompat());
    ...
    public HttpClient(Logger log, Context context, String authToken) {
        this(log, context);
        ...
        networkInterceptors().add(new PreemptiveOAuthenticationInterceptor(authToken));
        //setAuthenticator(new OAuthAuthenticator(null, authToken));
    ...
    public HttpClient(Logger log, HttpClient client, String host) {
        ...
        if(client.authToken != null) {
            ...
            networkInterceptors().add(new PreemptiveOAuthenticationInterceptor(authToken));
            //setAuthenticator(new OAuthAuthenticator(host, authToken));
        } else {
    ...
    @RequiredArgsConstructor
    static class PreemptiveOAuthenticationInterceptor implements Interceptor {
    ...
    public static void addLogger(HttpClient client) {
