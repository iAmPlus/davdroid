...
public class CardDavAddressBook extends RemoteCollection<Contact> {
	...
	public CardDavAddressBook(CloseableHttpClient httpClient, String baseURL, String accessToken) throws URISyntaxException {
		super(httpClient, baseURL, accessToken);
	}
}
